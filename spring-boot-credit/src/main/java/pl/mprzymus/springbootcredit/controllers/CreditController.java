...
public class CreditController {
    ...
    @PostMapping
    public String createCredits(@RequestBody CreditInfo creditInfo) {
        log.info("Called");
        ...
        var productCall = restTemplate.postForObject
                ("http://product-service/products", productInfoDto, String.class);
        ...
        var customerCall = restTemplate.postForObject
                ("http://customer-service/customers", customerInfoDto, String.class);
